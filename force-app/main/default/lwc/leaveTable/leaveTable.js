...
import getLeaveDetails from '@salesforce/apex/leaveTable.getLeaveDetails';
const options = [
		{label:'---None---', value:''},
...
export default class LeaveTable extends NavigationMixin(LightningElement) {
		@track recordEnd = 0;
		@track recordStart = 0;
		@track pageNumber = 1;
    ...
    this[NavigationMixin.Navigate](config);*/
		...
		gettingData(){
				...
				getLeaveDetails({filSession:this.sessionValue,empId:this.empRecId,filStatus:this.statusValue,monthFilter:this.monthValue,pageSize: this.pageSize, pageNumber : this.pageNumber})
						.then(result =>{
						this.loaderSpinner = true;
						if(result){
