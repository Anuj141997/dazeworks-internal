 ...
 * 1.0   08-31-2022   Shivam Kumar   Initial Version
**/
...
import updateInterview from '@salesforce/apex/interviewManagement.updateInterview';
...
export default class InterviewManagement extends LightningElement {
    ...
    getData(){
        ...
        getInterviewList({empId: this.empId, level: this.levelValue, name: this.nameFilter})
        .then(result => {
	...
	handleToggleSection(event) {
		...
		if(this.activeSectionMessage =='Technical_Initial_Feedback'){
			this.TechRating =false;
			this.TechInitRating=true;
			this.QARating=false;
		}
		else if(this.activeSectionMessage=='Feedback'){
			this.TechRating =true;
			this.TechInitRating=false;
			this.QARating=false;
		}
		else if(this.activeSectionMessage=='QA_Ratings'){
			this.TechRating =false;
			this.TechInitRating=false;
			this.QARating=true;
		}
